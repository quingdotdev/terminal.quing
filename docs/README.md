...
| document | focus |
| --- | --- |
| [overview.md](overview.md) | product scope and intent |
| [usage.md](usage.md) | day to day operation and shortcuts |
| [profiles.md](profiles.md) | shell profiles, args, and cwd |
| [workspace.md](workspace.md) | persistence, import, and export |
